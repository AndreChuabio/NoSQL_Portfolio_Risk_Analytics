...
- MongoDB cloud latency higher than target (expected for free tier)
- Redis cache hit rate low due to TTL (easy fix)
- Concurrent user handling needs connection pool tuning
